...
export function isPresetEnabled(editorOptions: Record<string, any> | undefined, editorOptionKey: string, presetIdentifier: string): boolean {
  return !!(editorOptions?.[editorOptionKey]?.[presetIdentifier]);
}

export type NeosEditorOptions = {
